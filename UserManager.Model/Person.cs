...
namespace UserManager.Model
{
    ...
    public class Person
    {
        ...
        [XmlElement(nameof(FirstName))] public string FirstName { get; set; }
        [XmlElement(nameof(LastName))] public string LastName { get; set; }
        [XmlElement(nameof(BirthDate))] public DateTime BirthDate { get; set; }
        [XmlIgnore] public short Age { get; set; }
        ...
        public void SetAge()
        {
            Age = Convert.ToInt16(DateTime.Today.Year - BirthDate.Year);
        }
    }
}
